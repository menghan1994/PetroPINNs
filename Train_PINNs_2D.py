...
def load_all_training_data(case_list = list(range(250))):
...
def train(lambd, weight_decay):
    ...
    ConnectionsDict = {0: [0], 1: [0, 1], 2: [1], 3: [
    0, 2], 4: [0, 1, 2, 3], 5: [1, 3], 6: [2], 7: [2, 3], 8: [3]}
    TOTAL_WELL_NUMS = 13
    INJECTOR_NUMS = 4
    PRODUCER_NUMS = 9
    ...
    params = {
        ...
        'INITIAL_PRESSURE': 5863.8,
        'Bo':1.30500,
        'RockCompressibility': 8.1e-6,
        'mu_w': 0.31,
        'mu_o': 0.29,
        'hid_dim': 128
    }
    ...
    test_water_inject_rate, test_producer_bottom_pressure, test_T, test_OPR, test_WPR = load_all_training_data(list(range(200, 230)))
...
def trainPureML():
    ...
    model_name = f'PureML/2D_PureMachineLearningModel'
